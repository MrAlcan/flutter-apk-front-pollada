...
/// Tabla de posiciones animada. Cuando llegan datos nuevos se calcula la
/// diferencia de orden por usuario y las filas que cambian de puesto se
/// animan (salida + entrada deslizante) con AnimatedList.
class LeaderboardList extends StatefulWidget {
  ...
  /// Id del usuario autenticado, para resaltar su fila.
      ...
      child: FadeTransition(
        ...
        child: SlideTransition(
          ...
          child: LeaderboardRow(
            entry: entry,
            highlighted: entry.userId == widget.highlightUserId,
          ),
        ),
      ),
    );
